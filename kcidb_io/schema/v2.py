...
from kcidb_io.schema.v1 import Version as PreviousVersion
...
class Version(PreviousVersion):
    ...
    json = {
        ...
        "description":
            ...
            "not required, and no default values should be assumed for "
            "them. At the same time, no properties can be null.\n"
            "\n"
        ...
        "$defs": {
            ...
            "resource": {
                ...
                "properties": {
                    "name": {
                        "type": "string",
                        "description":
                            "Resource name. Must be usable as a local "
                            "file name for the downloaded resource. "
                            "Cannot be empty. Should not "
                            "include directories.",
                        "pattern": "^[^/]+$",
                    },
                    "url": {
            ...
            "revision": {
                ...
                "description":
                    ...
                    "\n"
                    "Represents a way the tested source code could "
                    "be obtained. E.g. checking out a particular commit "
                    "from a git repo, and applying a set of patches on top.",
                "type": "object",
                "properties": {
                    "id": {
                        "type": "string",
                        "description":
                            ...
                            "the CI system which submitted the revision, "
                            "followed by a colon ':' character. The "
                            "rest of the string is generated by the origin "
                            "CI system, and must identify the revision "
                            "uniquely among all revisions, coming from that "
                            "CI system.\n",
                        "pattern": id_pattern,
                    },
                    "git_repository_url": {
                        ...
                        "description":
                            ...
                            "https:// URL, or, if that's not available, "
                    ...
                    "discovery_time": {
                        ...
                        "description":
                            ...
                            "a patch message, or noticed a new commit or "
                            "a new tag in a git repo.",
                    },
                    "contacts": {
                        "type": "array",
                        "description":
                            "List of e-mail addresses of contacts concerned"
                            " with this revision, such as authors, "
                            "reviewers, and mail lists",
                        "items": {
                            "type": "string",
                            "description":
                                "An e-mail address of a contact concerned "
                                "with this revision, e.g. an author, "
                                "a reviewer, or a mail list, as in "
                    ...
                    "valid": {
                        "type": "boolean",
                        "description":
                            "True if the revision is valid, i.e. if its "
                            "parts could be combined. False if "
                            "not, e.g. if its patches failed to apply."
                    },
                    "misc": {
                        "type": "object",
                        "description":
                ...
                "properties": {
                    ...
                    "id": {
                        ...
                        "description":
                            ...
                            "followed by a colon ':' character. The "
                            "rest of the string is generated by the "
                            "origin CI system, and must identify the "
                            "build uniquely among all builds, coming "
                            "from that CI system.\n",
                        "pattern": id_pattern,
                    },
                    "description": {
                    ...
                    "valid": {
                        "type": "boolean",
                        "description":
                            "True if the build is valid, i.e. if it could be "
            ...
            "test": {
                ...
                "description":
                    ...
                    "which could identify a specific test "
                    "within a test suite (e.g. \"LTPlite.sem01\"), a whole "
                    "test suite (e.g. \"LTPlite\"), or the summary of all "
                ...
                "properties": {
                    ...
                    "path": {
                        ...
                        "description":
                            ...
                            " E.g. \"LTPlite.sem01\". "
                            "The empty string signifies the root of the "
                            "tree, i.e. all tests for the build, "
                    ...
                    "status": {
                        ...
                        "description":
                            ...
                            "collection of test runs, e.g. for all testing "
                            "done on a build, based on results of executed "
                            "test suites. The summary status would be the "
                            "highest priority status across all test runs "
                            "in a collection.",
    ...
    def _get_version(cls, data):
        ...
        try:
            ...
            if isinstance(version, dict):
                return super()._get_version(data)
