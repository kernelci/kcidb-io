...
from kcidb_io.schema import v1
    ...
    "$defs": {
            ...
            "properties": {
                "id": {
                    ...
                    "description":
                        ...
                        "CI system, and must identify the revision uniquely "
                ...
                "message_id": {
                    ...
                    "description":
                        ...
                        "if any. E.g. a message with the revision's patchset, "
        ...
        "run": {
            ...
            "description":
                ...
                "within a test suite (e.g. \"LTPlite.sem01\"), a whole test "
            ...
            "properties": {
                ...
                "id": {
                    ...
                    "description":
                        ...
                        "followed by a colon ':' character. The rest of the "
                        "string is generated by the origin CI system, and "
                        "must identify the test run uniquely "
                ...
                "status": {
                    ...
                    "description":
                        ...
                        "used for producing a summary status for a collection "
                        "of test runs, e.g. for all testing done on a "
                        "build, based on results of executed test suites. "
                        "The summary status would be the highest priority "
