...
# JSON schema for a source code being tested
JSON_SOURCE = {
    "title": "source",
    "description":
        "The tested source code.\n"
        "\n"
        "Represents the tested source code and the way it could be obtained. "
        "E.g. checking out a particular commit from a git repo, and applying "
        "a set of patches on top.\n"
        "\n"
        "There could be multiple sources for the same code revision. Such as "
        "the same commit appearing in multiple Git repos, or the same "
        "patchset sent to multiple maillists. The particular revision is "
        "identified with the value of \"revision_id\" field.",
    "type": "object",
    "properties": {
        "revision_id": {
            "type": "string",
            "description":
                "ID of the source code revision.\n"
                "\n"
                "Must contain the full commit hash of the base source "
                "code in the Git repository.\n"
                "\n"
                "If the source had patches applied to the base code, "
        ...
        "id": {
            ...
            "description":
                ...
                "system which submitted the source, followed by a colon "
                "':' character. The rest of the string is generated by the "
                "origin CI system, and must identify the source uniquely "
                "among all sources, coming from that CI system.\n",
            "pattern": f"^{ORIGIN_ID_PATTERN}$",
        },
        "origin": {
            "type": "string",
            "description":
                "The name of the CI system which submitted the source",
        ...
        "tree_name": {
            ...
            "description":
                ...
                "main code tree where the base source code came from.",
            "examples": [
                "net-next",
                "rdma",
                "mainline",
        ...
        "git_repository_url": {
            ...
            "format": "uri",
            "description":
                "The URL of the Git repository which contains the base "
                "source code. The shortest possible https:// URL, or, if "
        ...
        "git_commit_hash": {
            "type": "string",
            "description":
                "The full commit hash of the base source code",
        ...
        "git_commit_name": {
            ...
            "description":
                ...
                "source code, as would be output by \"git describe\", at the "
                "discovery time."
        },
        "git_repository_branch": {
            ...
            "description":
                ...
                "base source code was discovered."
        },
        "patch_mboxes": {
            "type": "array",
            "description":
                "List of mboxes containing patches applied to the base "
                "source code, in order of application",
            "items": JSON_RESOURCE,
        },
        "message_id": {
            "type": "string",
            ...
            "description":
                ...
                "introducing this source code, if any. E.g. a message with "
                "the source's patchset, or a release announcement sent to "
                "a maillist.",
        },
        "description": {
            "type": "string",
            "description":
                "Human-readable description of the source code. "
        ...
        "publishing_time": {
            ...
            "format": "date-time",
            "description":
                "The time the source was made public. E.g. the timestamp "
        ...
        "discovery_time": {
            ...
            "format": "date-time",
            "description":
                "The time the source was discovered by the CI system. "
        ...
        "contacts": {
            ...
            "description":
                ...
                "this source code, such as authors, reviewers, and mail "
                "lists",
            "items": {
                "type": "string",
                "description":
                    "An e-mail address of a contact concerned with this "
                    "source, e.g. an author, a reviewer, or a mail list, "
        ...
        "log_url": {
            ...
            "format": "uri",
            "description":
                "The URL of the log file of the attempt to construct the "
                "source code from its parts. E.g. 'git am' output.",
        },
        "valid": {
            "type": "boolean",
            "description":
                "True if the source code is valid, i.e. if its parts could "
                "be combined. False if not, e.g. if its patches failed to "
                "apply."
        },
        "misc": {
            "type": "object",
            "description":
                "Miscellaneous extra data about the source code",
        },
    },
    "additionalProperties": False,
    "required": [
...
# JSON schema for a build of a source code
JSON_BUILD = {
    "title": "build",
    "description": "A build of a source code",
    "type": "object",
    "properties": {
        "source_id": {
            "type": "string",
            "description":
                "ID of the built source code. The source must "
    ...
    "properties": {
        ...
        "waived": {
            ...
            "description":
                ...
                "with the tested source code. For example, for collecting "
...
JSON = {
    ...
    "description":
        ...
        "the build and its source code are present.\n"
        "\n"
    ...
    "properties": {
        ...
        "sources": {
            "description": "List of code sources",
            "type": "array",
            "items": JSON_SOURCE,
        },
        "builds": {
...
def inherit(data):
    ...
    if 'revisions' in data:
        # Rename "revisions" to "sources" and generate new IDs
        sources = data.pop('revisions')
        for source in sources:
            revision_id = source['id']
            source['revision_id'] = revision_id
            source['id'] = "_:" + revision_id
        data['sources'] = sources

    # Switch from revision IDs to source IDs in builds
    for build in data.get('builds', []):
        build['source_id'] = "_:" + build.pop('revision_id')
