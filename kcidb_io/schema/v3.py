...
import re
from kcidb_io.schema.v2 import Version as PreviousVersion
...
class Version(PreviousVersion):
    ...
    json = {
        ...
        "description":
            ...
            "character. The rest of the string is generated by the origin CI "
            "system, and must identify that object uniquely among all "
        ...
        "$defs": {
            ...
            "revision": {
                ...
                "description":
                    ...
                    "\n"
                    "Represents a way the tested source code could be "
                    "obtained. E.g. checking out a particular commit from "
                    "a git repo, and applying a set of patches on top.",
                "type": "object",
                "properties": {
                    "id": {
                        "type": "string",
                        "description":
                            "Revision ID.\n"
                            "\n"
                            "Must contain the full commit hash of the "
                            "revision's base code in the Git repository.\n"
                            "\n"
                            "If the revision had patches applied to the base "
                            "code, the commit hash should be followed by the "
                            "'+' character and a sha256 hash over "
                            "newline-terminated sha256 hashes of each "
                            "applied patch, in order. E.g. generated with "
                            "this shell command: \"sha256sum *.patch | "
                            "cut -c-64 | sha256sum | cut -c-64\".\n",
                        "pattern": f"^{revision_id_pattern}$",
                        "examples": [
                            "aa73bcc376865c23e61dcebd467697b527901be8",
                            "c0d73a868d9b411bd2d0c8e5ff9d98bfa8563cb1"
                            "+903638c087335b10293663c682b9aa0076f9f7b"
                            "e478a8e7828bc22e12d301b42"
                        ],
                    },
                    "origin": {
                        "type": "string",
                    ...
                    "tree_name": {
                        ...
                        "description":
                            ...
                            "(fork) of the main code tree that the "
                            "revision belongs to.",
                        "examples": [
                            "net-next",
                            "rdma",
                    ...
                    "git_repository_url": {
                        ...
                        "format": "uri",
                        "description":
                            "The URL of the Git repository which contains "
                    ...
                    "git_commit_name": {
                        ...
                        "description":
                            ...
                            "the base code of the revision, as would be output"
                            " by \"git describe\", at the discovery time."
                    },
                    ...
                    "message_id": {
                        ...
                        "description":
                            ...
                            "E.g. a message with the revision's patchset, "
                    ...
                    "publishing_time": {
                        ...
                        "format": "date-time",
                        "description":
                            "The time the revision was made public. E.g. the "
                            "timestamp on a patch message, a commit, "
                            "or a tag.",
                        "examples": [
                    ...
                    "discovery_time": {
                        ...
                        "format": "date-time",
                        "description":
                            "The time the revision was discovered by the "
                            "CI system. E.g. the time the CI system found "
                            "a patch message, or noticed a new commit "
                            "or a new tag in a git repo.",
                        "examples": [
                            "2020-08-14T23:08:06.967000+00:00",
                        ],
                    },
                    "contacts": {
                        ...
                        "description":
                            ...
                            "with this revision, such as authors, reviewers, "
                            "and mail lists",
                        "items": {
                            "type": "string",
                            "description":
                    ...
                    "log_url": {
                        ...
                        "format": "uri",
                        "description":
                            "The URL of the log file of the attempt to "
                            "construct this revision from its parts. "
                            "E.g. 'git am' output.",
                    },
                    "valid": {
                        "type": "boolean",
                        "description":
                            "True if the revision is valid, i.e. if its parts "
                            "could be combined. False if not, e.g. "
                            "if its patches failed to apply."
                    },
                    "misc": {
                        "type": "object",
                        "description":
            ...
            "build": {
                ...
                "properties": {
                    ...
                    "id": {
                        ...
                        "description":
                            ...
                            "the string is generated by the origin CI system, "
                            "and must identify the build uniquely "
                    ...
                    "compiler": {
                        "type": "string",
                        "description":
                            "Name and version of the compiler used to make"
                            " the build",
                    },
                    "input_files": {
                        "type": "array",
                ...
                "additionalProperties": False,
                "required": ["revision_id", "id", "origin"],
            },
            ...
            "test": {
                ...
                "description":
                    ...
                    "program, a result of one of the tests done by the "
                    "test suite program, as well "
                    "as a summary of a collection of test suite results.\n"
                    "\n"
                    "Each test run should normally have a dot-separated test "
                    "\"path\" specified in the \"path\" property, which could "
                    "identify a specific test within a test suite "
                    "(e.g. \"LTPlite.sem01\"), a whole test "
                    "suite (e.g. \"LTPlite\"), or the summary of all"
                    " tests for a build ("" - the empty string).",
                "type": "object",
                "properties": {
                    "build_id": {
                        "type": "string",
                    ...
                    "id": {
                        ...
                        "description":
                            ...
                            "system, and must identify the test run uniquely "
                            "among all test runs, coming from that CI "
                            "system.\n",
                        "pattern": f"^{origin_id_pattern}$",
                    },
                    "origin": {
                    ...
                    "path": {
                        ...
                        "description":
                            ...
                            " to. E.g. \"ltp.sem01\". The empty string "
                            "signifies the root of the tree, i.e. all tests "
                            "for the build, executed by the origin CI system.",
                        "pattern": "^[.a-zA-Z0-9_-]*$",
                        "examples": [
                            "",
                            "ltp",
                    ...
                    "waived": {
                        ...
                        "description":
                            ...
                            "revision. For example, for collecting test "
                            "reliability statistics when the test is first "
    ...
    def _inherit(cls, data):
        ...
        for revision in data.get("revisions", []):
            for old, new in (
                ("git_repository_commit_hash", "git_commit_hash"),
        ...
        # Update version
        data['version'] = dict(major=Version.major, minor=Version.minor)
        return data
