    ...
    "$defs": {
        ...
        "resource": {
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "description":
                        "Resource name. Must be usable as a local file name "
                        "for the downloaded resource. Cannot be empty. "
            ...
            "examples": [
                {
                    ...
                    "url":
                        ...
                        "logs/aarch64_host_1_console.log"
                },
                {
                    "name": "kernel.tar.gz",
                    "url":
        ...
        "revision": {
            ...
            "description":
                ...
                "\n"
                "Represents a way the tested source code could be obtained. "
                "E.g. checking out a particular commit from a git repo, "
            ...
            "properties": {
                "id": {
                    ...
                    "description":
                        "Revision ID.\n"
                        "\n"
                        "Must contain the full commit hash of the revision's "
                        "base code in the Git repository.\n"
                        "\n"
                        "If the revision had patches applied to the base "
                        "code, the commit hash should be followed by the '+' "
                        "character and a sha256 hash over newline-terminated "
                        "sha256 hashes of each applied patch, in order. "
                        "E.g. generated with this shell command: \""
                ...
                "git_repository_url": {
                    ...
                    "description":
                        ...
                        "the base code of the revision. The shortest possible "
                ...
                "publishing_time": {
                    ...
                    "description":
                        ...
                        "timestamp on a patch message, a commit, or a tag.",
                    "examples": [
                ...
                "contacts": {
                    ...
                    "description":
                        ...
                        "this revision, such as authors, reviewers, and "
                        "mail lists",
                    "items": {
                        "type": "string",
                        "description":
                            "An e-mail address of a contact concerned with "
                            "this revision, e.g. an author, a reviewer, "
                ...
                "log_url": {
                    ...
                    "format": "uri",
                    "description":
                        "The URL of the log file of the attempt to construct"
                        " this revision from its parts. "
                        "E.g. 'git am' output.",
                },
                "valid": {
                    "type": "boolean",
            ...
            "properties": {
                ...
                "id": {
                    ...
                    "description":
                        ...
                        "\n"
                        "Must start with a non-empty string identifying "
                        "the CI system which submitted the test run, followed "
                        "by a colon ':' character. The rest of the string is "
                        "generated by the origin CI system, and must "
                        "identify the test run uniquely "
