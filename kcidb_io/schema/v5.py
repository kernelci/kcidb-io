            ...
            "properties": {
                ...
                "git_repository_url": {
                    ...
                    "description":
                        ...
                        "checked out base source code. The shortest possible "
                ...
                "git_commit_name": {
                    ...
                    "description":
                        ...
                        "the checked out base source code, as would be output "
                        "by \"git describe\", at the checkout time."
                },
                ...
                "patchset_hash": {
                    ...
                    "description":
                        ...
                        "generated with this shell command: \"sha256sum "
                        "*.patch | cut -c-64 | sha256sum | cut -c-64\""
                        ".\n\n"
                ...
                "contacts": {
                    ...
                    "description":
                        ...
                        "with the checked out source code, such as authors,"
                        " reviewers, and mail lists",
                    "items": {
                        "type": "string",
                        "description":
                            "An e-mail address of a contact concerned with "
                            "this code, e.g. an author, a reviewer, "
                ...
                "valid": {
                    "type": "boolean",
                    "description":
                        "True if the checkout succeeded, i.e. if the source "
                        "code parts could be combined. False if not, e.g. "
                        "if the patches failed to apply."
                },
                "misc": {
                    "type": "object",
                    "description":
            ...
            "properties": {
                ...
                "log_excerpt": {
                    ...
                    "examples": [
                        ...
                        "SYS_ ## k ## KEYLO_EL1);     \\\n"
                        "        ^\n./arch/arm64/include/asm/sysreg.h:829:37:"
            ...
            "properties": {
                ...
                "id": {
                    ...
                    "description":
                        ...
                        "run uniquely among all test runs, coming from that"
                        " CI system.\n",
                    "pattern": f"^{ORIGIN_ID_PATTERN}$",
                },
                "origin": {
                ...
                "log_url": {
                    ...
                    "description":
                        ...
                        "If the test produced multiple outputs/files, "
                        "this should point to the one containing "
                        "the highest-level overview of the test's "
                        "operation. The rest should go into \"output_files\"."
                },
                "log_excerpt": {
                    "type": "string",
                    "maxLength": 16384,
                ...
                "waived": {
                    ...
                    "description":
                        ...
                        "affecting the overall test status and alerting the "
                        "contacts concerned with the checked out and tested "
                        "source code. For example, for collecting test "
                        "reliability statistics when the test is "
...
VERSION = Version(JSON_VERSION_MAJOR, JSON_VERSION_MINOR, JSON,
                  TREE, v4.VERSION.get_version, v4.VERSION,
                  inherit)
